...
import { AppWindow, MonitorPlay, Plus, Trash2 } from 'lucide-react'
...
function App() {
  ...
  const layout = useDefaultLayout({ id: 'cloud-windows-layout' })
    ...
    <div className="h-screen bg-background text-foreground">
      ...
      >
        ...
        <div className="flex items-center gap-3 p-4">
          ...
          <div>
            <h1 className="font-heading text-base font-medium">Cloud Windows</h1>
            <p className="text-xs text-muted-foreground">云端 Windows 桌面</p>
          </div>
        </div>
        <Separator />
      ...
      >
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              确定要删除会话「{pendingDelete?.title}」吗？关联的 Windows 沙箱也会被销毁。
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
