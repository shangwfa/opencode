...
import { ArrowUp, Loader2, MonitorPlay } from 'lucide-react'
...
const EXAMPLES = [
  '在 Windows 沙箱中安装 Python 并运行脚本',
  '用 PowerShell 查询系统信息并整理报告',
  '在 Windows 中安装 Chrome 并打开 GitHub',
]
    ...
    <div className="flex flex-1 flex-col items-center justify-center px-8">
      <div className="w-full max-w-2xl space-y-8">
        <div className="flex items-center justify-center gap-3">
          ...
          <h1 className="font-heading text-2xl font-semibold">Cloud Windows Agent</h1>
        </div>
        ...
        >
          <textarea
            ...
            placeholder="描述你的需求，AI 将在云端 Windows 沙箱中执行..."
            rows={4}
            disabled={submitting}
