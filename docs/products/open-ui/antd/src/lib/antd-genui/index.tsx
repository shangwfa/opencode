...
import { AntdBadgeComponent } from "./components/badge";
...
import { UiTag, TagBlock } from "./components/tag";
...
export const antdComponentGroups: ComponentGroup[] = [
  {
    name: "Content",
    components: [
      "CardHeader",
...
export const antdExamples: string[] = [
...
export const antdAdditionalRules: string[] = [
...
export const antdPromptOptions: PromptOptions = {
  examples: antdExamples,
  additionalRules: antdAdditionalRules,
};

export const antdChatLibrary = createLibrary({
  root: "Card",
  componentGroups: antdComponentGroups,
  components: [
    ChatCard,
    CardHeader,
    TextContent,
