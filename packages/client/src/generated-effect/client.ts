...
type Endpoint8_0Request = Parameters<RawClient["server.connector"]["connector.list"]>[0]
type Endpoint8_0Input = { readonly location?: Endpoint8_0Request["query"]["location"] }
const Endpoint8_0 = (raw: RawClient["server.connector"]) => (input?: Endpoint8_0Input) =>
  raw["connector.list"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint8_1Request = Parameters<RawClient["server.connector"]["connector.get"]>[0]
type Endpoint8_1Input = {
  readonly connectorID: Endpoint8_1Request["params"]["connectorID"]
  readonly location?: Endpoint8_1Request["query"]["location"]
}
const Endpoint8_1 = (raw: RawClient["server.connector"]) => (input: Endpoint8_1Input) =>
  raw["connector.get"]({ params: { connectorID: input["connectorID"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint8_2Request = Parameters<RawClient["server.connector"]["connector.connect.key"]>[0]
type Endpoint8_2Input = {
  readonly connectorID: Endpoint8_2Request["params"]["connectorID"]
  readonly location?: Endpoint8_2Request["query"]["location"]
  readonly methodID: Endpoint8_2Request["payload"]["methodID"]
...
const Endpoint8_2 = (raw: RawClient["server.connector"]) => (input: Endpoint8_2Input) =>
  raw["connector.connect.key"]({
    params: { connectorID: input["connectorID"] },
    query: { location: input["location"] },
    payload: { methodID: input["methodID"], key: input["key"], inputs: input["inputs"], label: input["label"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint8_3Request = Parameters<RawClient["server.connector"]["connector.connect.oauth.begin"]>[0]
type Endpoint8_3Input = {
  readonly connectorID: Endpoint8_3Request["params"]["connectorID"]
...
const Endpoint8_3 = (raw: RawClient["server.connector"]) => (input: Endpoint8_3Input) =>
  raw["connector.connect.oauth.begin"]({
    params: { connectorID: input["connectorID"] },
    query: { location: input["location"] },
    payload: { methodID: input["methodID"], inputs: input["inputs"], label: input["label"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint8_4Request = Parameters<RawClient["server.connector"]["connector.connect.oauth.status"]>[0]
...
const Endpoint8_4 = (raw: RawClient["server.connector"]) => (input: Endpoint8_4Input) =>
  raw["connector.connect.oauth.status"]({
    params: { attemptID: input["attemptID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint8_5Request = Parameters<RawClient["server.connector"]["connector.connect.oauth.complete"]>[0]
...
const Endpoint8_5 = (raw: RawClient["server.connector"]) => (input: Endpoint8_5Input) =>
  raw["connector.connect.oauth.complete"]({
    params: { attemptID: input["attemptID"] },
    query: { location: input["location"] },
    payload: { code: input["code"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint8_6Request = Parameters<RawClient["server.connector"]["connector.connect.oauth.cancel"]>[0]
...
const Endpoint8_6 = (raw: RawClient["server.connector"]) => (input: Endpoint8_6Input) =>
  raw["connector.connect.oauth.cancel"]({
    params: { attemptID: input["attemptID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

const adaptGroup8 = (raw: RawClient["server.connector"]) => ({
  list: Endpoint8_0(raw),
  get: Endpoint8_1(raw),
  key: Endpoint8_2(raw),
  begin: Endpoint8_3(raw),
  status: Endpoint8_4(raw),
  complete: Endpoint8_5(raw),
  cancel: Endpoint8_6(raw),
})
...
type Endpoint15_0Input = {
  ...
  readonly sessionID?: Endpoint15_0Request["query"]["sessionID"]
}
...
type Endpoint15_1Input = {
  ...
  readonly sessionID?: Endpoint15_1Request["query"]["sessionID"]
...
type Endpoint15_2Input = {
  ...
  readonly sessionID?: Endpoint15_2Request["query"]["sessionID"]
}
...
type Endpoint15_3Input = {
  ...
  readonly sessionID?: Endpoint15_3Request["query"]["sessionID"]
...
type Endpoint15_4Input = {
  ...
  readonly sessionID?: Endpoint15_4Request["query"]["sessionID"]
}
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.connector": adaptGroup8(raw["server.connector"]),
