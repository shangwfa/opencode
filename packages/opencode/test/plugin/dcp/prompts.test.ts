...
import { PromptStore } from "../../../src/plugin/dcp/lib/prompts/store"
import { SYSTEM as SYSTEM_PROMPT } from "../../../src/plugin/dcp/lib/prompts/system"
...
test("plain-text mentions do not invalidate copied system prompt overrides", () => {
...
test("fully wrapped overrides are normalized to a single runtime wrapper", () => {
        const fixture = createPromptStoreFixture(
...
test("malformed boundary wrappers are rejected", () => {
