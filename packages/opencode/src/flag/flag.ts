...
export namespace Flag {
  ...
  export const OPENCODE_LLM_STALL_TIMEOUT_SEC = number("OPENCODE_LLM_STALL_TIMEOUT_SEC") ?? 300
  export const OPENCODE_SESSION_STALE_RUN_SEC = number("OPENCODE_SESSION_STALE_RUN_SEC") ?? 1800
  export const OPENCODE_SESSION_LOCK_TIMEOUT_SEC = number("OPENCODE_SESSION_LOCK_TIMEOUT_SEC") ?? 120
  export const OPENCODE_SESSION_LOCK_POOL_SIZE = number("OPENCODE_SESSION_LOCK_POOL_SIZE") ?? 8
