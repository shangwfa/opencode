...
export { define } from "@ocv1/schema/rpc"
export type { Definition, EventPayload, Failure } from "@ocv1/schema/rpc"

import type { RpcClient, RpcDomain, RpcHandlers } from "@ocv1/plugin/effect/rpc"
import type { Rpc } from "@ocv1/schema/rpc"
import { Event } from "@ocv1/schema/event"
import type { Tool } from "@ocv1/schema/tool"
