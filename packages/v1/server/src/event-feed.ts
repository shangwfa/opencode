...
import { isOpenCodeEvent, type OpenCodeEvent } from "@ocv1/protocol/groups/event"
...
export class Service extends Context.Service<Service, Interface>()("@ocv1/server/EventFeed") {}
